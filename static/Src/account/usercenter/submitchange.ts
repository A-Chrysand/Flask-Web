function submit_BaisicInfoChange_js_post() {
	let send_username = $("#input_username").val()
	let send_email = $("#input_email").val()
	let send_phone = $("#input_phone").val()
	let send_xuehao = $("#input_schoolNumber").val()
...
function submit_SecretInfoChange_js_post() {
	let send_username = sessionStorage.getItem("file_currentuser")
	let send_psw = $("#exampleInputPassword1").val()
	/*
	...
	*/
	...
	let send_q3 = "1233"
	//let register_mingwen: string = send_username + '/' + send_email + '/' + send_phone + '/' + send_xuehao;
	let register_mingwen: string = send_username + '/' + send_psw + '/' + send_q1 + '/' + send_q2 + '/' + send_q3;
	// @ts-ignore
	let register_sendout: string = Generate.Cipher_Num(register_mingwen);
